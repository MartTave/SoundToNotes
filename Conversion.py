...
fichier_audio = 'MusicTest/BrotherJacques.wav'
...
for frame in onset_frames:
    ...
    for numero_note in notes_actives:
        note_off = mido.Message('note_off', note=numero_note, velocity=64, time=avance_temporelle)
        piste.append(note_off)

# Enregistrer le fichier MIDI
sortie_midi.save('Brother.mid')
